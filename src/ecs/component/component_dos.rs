...
//     component_array: [Option<>; MAX_ENTITIES as usize],
...
//     }
//
//     pub fn get_data(&self, entity: EntityType) -> &Box<dyn IComponent> {
//         assert!(
//             self.entity_to_index_map.contains_key(&entity),
//             "Retrieving non-existent component."
//         );
//
//         self.component_array[self.entity_to_index_map[&entity]]
//             .as_ref()
//             .expect("Component should exist.")
//     }
//     pub fn get_components(&mut self) -> &[Option<Box<dyn IComponent>>; MAX_ENTITIES as usize] {
